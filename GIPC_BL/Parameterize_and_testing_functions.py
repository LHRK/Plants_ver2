...
def prepare_setup_BL(itp_loc, mdp_loc, lipids='POPC DPPC DIPC DPSM CHOL DBPC DOPC', PME=False):
...
def run_BL_hexagonal (resname,GRO,TOP, mdp_loc='/data1/lisbeth/Params/BILAYERS/MDPs/HEXAGONAL', maxwarn=1, lipids='POPC DPPC DIPC DPSM CHOL DBPC DOPC'):
